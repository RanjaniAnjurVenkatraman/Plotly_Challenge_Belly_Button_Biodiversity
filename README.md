# Plotly_Challenge_Belly_Button_Biodiversity
...
## Background 
In this project, an interactive dashboard was built to explore the [Belly Button Biodiversity dataset](/data/samples.json), which catalogs the microbes that colonize human navels in JSON format.
...
**The dashboard can be viewed here: <a href="https://ranjanianjurvenkatraman.github.io/Plotly_Challenge_Belly_Button_Biodiversity/" target="_blank">Belly Button Biodiversity Dashboard</a>**
